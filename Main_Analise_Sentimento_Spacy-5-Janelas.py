    ...
    for i, text in enumerate(all_reviews):
        ...
        for x, token in enumerate(text):
            ...
            if word in sent_words and word not in stop_words:
                ...
                if palavra[x-1] in intensificacao or palavra[x-2] in intensificacao or palavra[x-3] in intensificacao or palavra[x-4] in intensificacao:
                    if palavra[x-1] in negacao or palavra[x-2] in  negacao or palavra[x-3] in negacao or palavra[x-4] in negacao:
                        polaridade = polaridade/3                        
                    else:
                        polaridade = polaridade*3

                elif palavra[x-1] in reducao or palavra[x-2] in reducao or palavra[x-3] in reducao or palavra[x-4] in reducao:
                    if palavra[x-1] in negacao or palavra[x-2] in  negacao or palavra[x-3] in negacao or palavra[x-4] in negacao:
                        polaridade = polaridade*3
                    else:
                        polaridade = polaridade/3
                        
                elif palavra[x-1] in negacao or palavra[x-2] in  negacao or palavra[x-3] in negacao or palavra[x-4] in negacao:
